    ...
    exports.installDataInterceptor = function (config) {
        ...
        window.GAWebTester = {
            ...
            gaCallback: function () {
                ...
                event.initEvent(window.GAWebTester.formatGAWebTesterEventName(providedArguments), true, true);
             ...
             * @private
             */
            formatGAWebTesterEventName: function (eventData) {
            ...
            registerSingleEventCallback: function (eventData, callback) {
                ...
                var eventName = window.GAWebTester.formatGAWebTesterEventName(eventData);
